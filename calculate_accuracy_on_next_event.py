...
csvfile = open('C:/Users/Villain/Desktop/Thesis/ProcessSequencePrediction-master/code/output_files/models/results/suffix_and_remaining_time_%s.csv', 'rb')
rb = unicodecsv.reader(csvfile ,encoding='utf-8')
r = rb
##r.next() # header
vals = dict()
for row in r:
