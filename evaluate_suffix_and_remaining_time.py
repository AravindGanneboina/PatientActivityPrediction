...
csvfile = open('C:/Users/Villain/Desktop/patient15-30.csv', 'r')
...
model = load_model('C:/Users/Villain/Desktop/Thesis/ProcessSequencePrediction-master/code/output_files/models/model_01-0.79.h5')
...
# make predictions
with open('output_files/results/suffix_and_remaining_time', 'w') as csvfile:
    #csvfile = str.encode(csvfile)
